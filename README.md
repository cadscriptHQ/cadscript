[![Unit Tests](https://github.com/cadscriptHQ/cadscript/actions/workflows/python-package.yml/badge.svg)](https://github.com/cadscriptHQ/cadscript/actions/workflows/python-package.yml)
