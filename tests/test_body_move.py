...
class BodyMoveTest(unittest.TestCase):
    ...
    def test_box_center_x(self):
        ...
        box.center("X")
        self.assertEqual(box.get_extent(), ((-1, 1), (0, 4), (0, 6)))

    def test_box_center_y(self):
        box = cadscript.make_box(2, 4, 6, center=False)
        box.center("Y")
        self.assertEqual(box.get_extent(), ((0, 2), (-2, 2), (0, 6)))

    def test_box_center_z(self):
        box = cadscript.make_box(2, 4, 6, center=False)
        box.center("Z")
        self.assertEqual(box.get_extent(), ((0, 2), (0, 4), (-3, 3)))
    ...
    def test_box_center_xz(self):
        box = cadscript.make_box(2, 4, 6, center=False)
        box.center("XZ")
        self.assertEqual(box.get_extent(), ((-1, 1), (0, 4), (-3, 3)))

    def test_box_center_yz(self):
        box = cadscript.make_box(2, 4, 6, center=False)
        box.center("YZ")
        self.assertEqual(box.get_extent(), ((0, 2), (-2, 2), (-3, 3)))
